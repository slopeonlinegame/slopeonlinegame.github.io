...
$title = strtolower(trim($category->name)) . " games"; //action games games
...
echo \helper\themes::get_layout('game_item', array('category_id' => $category_id, 'title' => $title, 'description' => $description, 'enable_ads' => $enable_ads));
