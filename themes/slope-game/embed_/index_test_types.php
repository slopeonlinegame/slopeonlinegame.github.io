...
// check types: no ads footer (mobile)
...
// JS: attribute sandbox: Prevent opening external links
...
$list_fix = [
    'y8.com',
    'gameflare.com',
    // 'crazygames.com', // use or 'referrerPolicy', 'no-referrer'
];
    ...
    <head>
        ...
        <style type="text/css">
            * {
            ...
            /* check_footer_ads: 41px => 38px - 45px */
