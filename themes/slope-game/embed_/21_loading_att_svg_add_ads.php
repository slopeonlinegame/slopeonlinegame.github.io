<?php
// 21_loading_att_svg_add_ads: background: img blur + add btn ads
// layout: background blur: img - loading attribute svg wrap: img - name - flip effect btn  + add btn ads
                ...
                <div class="gpxLoader-game-icon" style="background-image: url(&quot;<?php echo \helper\image::get_thumbnail($game->image, 105, 105, "m"); ?>&quot;);">
                    <svg width="175" height="175" viewBox="0 0 100 100">
                        <linearGradient id="linearColors" x1="0" y1="0" x2="0" y2="1">
                            ...
                            <stop offset="50%" stop-color="#ffd65b"></stop>
                ...
                <div id="flipCard" class="flip-card active">
                    <div class="flip-card-inner" id="action">
                        <div class="flip-card-front" id="btn_play" style="display: none;">
                            <button class="gpxLoader-button" onclick="<?php echo ($game_type == 'EXTERNAL') ? 'openInNewWindow()' : 'start_game_frame()' ?>" aria-label="play game">Play Game</button>
                            <br>
                            <a class="gpxLoader-button btn_new" href="https://store.sprunki.org" target="_blank" title="Visit Sprunki Store">VISIT STORE</a>
                        </div>
