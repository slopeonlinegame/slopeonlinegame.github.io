...
$title = strtolower(trim($tag->name)) . " games"; //action games games
...
echo \helper\themes::get_layout('game_item', array('tag_id' => $tag_id, 'title' => $title, 'description' => $description, 'enable_ads' => $enable_ads));
