...
// sites Need to load game Now: url delete "www." || child/sub Path
$list_load_now = [
    'playminigames.net',
    'twoplayergames.org',
    'play-games.com',
...
// footer height == 35px (hide_footer: 38 - 45px => 41px)
$list_hide_footer_low = [
    'gameflare.com',
];
$check_hide_footer_low = check_list($list_hide_footer_low, $game->source_html);

// sites no need to hide footer (mobile)
$list_no_hide_footer_mobi = [
    'crazygames.com',
];
$check_no_hide_footer_mobi = check_list($list_no_hide_footer_mobi, $game->source_html);

// block get referrer => to play || delete exterl links (crazygames.com)
$list_no_referrer = [
    'snokido.com',
    // 'crazygames.com',
];
        ...
        <style type="text/css">
            * {
            ...
            .embed_wrap {
                ...
                --tw-gradient-from: rgba(170, 76, 143, .1) var(--tw-gradient-from-position);
            ...
            .backdrop_blur {
                position: absolute;
                inset: 0;
                background-color: rgba(170, 76, 143, .5);
            ...
            .btn_play {
                ...
                border-radius: 16px;
                --tw-bg-opacity: 1;
                background-color: rgb(170 76 143/var(--tw-bg-opacity, 1));
                padding: 20px 40px;
                font-size: 20px;
                line-height: 28px;
                font-weight: 700;
            ...
            .btn_play_span1 {
                ...
                --tw-gradient-from: rgba(170, 76, 143, .5) var(--tw-gradient-from-position);
                --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
                --tw-gradient-to: rgba(170, 76, 143, .2) var(--tw-gradient-to-position);
            }
            ...
            .btn_play:hover .btn_play_span {
                opacity: 1;
            }

            .btn_play:hover .btn_play_svg {
                --tw-scale-x: 1.1;
                --tw-scale-y: 1.1;
                transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
            }

            .btn_play:hover .btn_play_span3 {
                letter-spacing: .05em;
            }

            .btn_play:hover .btn_play_span4 {
                --tw-scale-x: 1;
                transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
            }
            ...
            .loading_wrap {
                ...
                background-color: rgba(170, 76, 143, .3);
                box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
                --tw-shadow: 0 20px 25px -5px rgba(0, 0, 0, .1), 0 8px 10px -6px rgba(0, 0, 0, .1);
                --tw-shadow-colored: 0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color);
                --tw-backdrop-blur: blur(12px);
            ...
            .loading_name {
                margin-bottom: 24px;
                background-image: linear-gradient(to bottom right, var(--tw-gradient-stops));
                --tw-gradient-from: #aa4c8f var(--tw-gradient-from-position);
            ...
            .loading_bar_style {
                ...
                --tw-gradient-to: #aa4c8f var(--tw-gradient-to-position);
                --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
                transition-property: all;
                transition-duration: .3s;
