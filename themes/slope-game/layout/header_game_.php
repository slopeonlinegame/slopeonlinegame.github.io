...
<div class="header-game">
    <div class="box-header">
        ...
        <div class="header-game-extend">
            <span class="share-btn" id="view-share_modal" onclick='showSharingBox()' title="Share">
            ...
            <span class="comment-btn" id="comment-focus" onclick='scrollToDiv(".comment-company")' title="Comment">
            ...
            <span class="theatemode" onclick="theaterMode()" title="Theatemode">
            ...
            <span class="expand-btn" id="expand" title="FullScreen">
...
<div role="presentation" class="css-wl8sln hide-share">
    <div class="css-l8b4om" aria-hidden="true" onclick='showSharingBox()'></div>
    <div tabindex="0" data-testid="sentinelStart"></div>
    <div tabindex="-1" class="css-1rh4j88">
        <div class="css-osmupm">
            <div class="css-d8hoyy">
                <button aria-label="close share" class="btn-close-share" type="button" onclick='showSharingBox()'>
                     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M4.29289 4.29289C4.68342 3.90237 5.31658 3.90237 5.70711 4.29289L12 10.5858L18.2929 4.29289C18.6834 3.90237 19.3166 3.90237 19.7071 4.29289C20.0976 4.68342 20.0976 5.31658 19.7071 5.70711L13.4142 12L19.7071 18.2929C20.0976 18.6834 20.0976 19.3166 19.7071 19.7071C19.3166 20.0976 18.6834 20.0976 18.2929 19.7071L12 13.4142L5.70711 19.7071C5.31658 20.0976 4.68342 20.0976 4.29289 19.7071C3.90237 19.3166 3.90237 18.6834 4.29289 18.2929L10.5858 12L4.29289 5.70711C3.90237 5.31658 3.90237 4.68342 4.29289 4.29289Z"></path>
                    </svg>
                </button>
            </div>
            <div style="padding-bottom: 20px;">
                <p class="title-share">Share <?php echo $game_name; ?></p>
                <div style="max-width: 100%; width: 600px;">
                    <div style="display: flex; justify-content: center; flex-wrap: wrap;">
                        ...
                        <button aria-label="twitter" class="btn-share" onclick=" window.open('https://twitter.com/share?text=<?php echo $game_name; ?>&url=<?php echo $url ?>', 'twitter-share-dialog', 'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0');return false">
                            <div class="btn-css css-1wtz2hp">
                                 <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="svg-css">
                    ...
                    <div class="css-chxnnc">
                        <button aria-label="copy link" class="btn-copy" type="button" onclick='copyLink()'>Copy</button>
                        <div class="css-1kgmm81">
                            <input id="input-share" readonly="" type="text" class="MuiInput-input" value="<?php echo $url ?>">
                        </div>
                    </div>
                </div>
            </div>
