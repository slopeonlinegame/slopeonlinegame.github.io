...
?>
<noscript>let url = '<?php echo $url ?>';</noscript>
<?php if ($comment_data != null && count($comment_data) > 0) : ?>
    ...
    ?>
        <div id="comment_<?php echo $comment->id ?>" data-url="<?php echo $url ?>" class="replyWrap clearAfter">
            ...
            <div class="listContent">
                <div class="comment--content"><?php echo htmlspecialchars($comment->get_content(), ENT_QUOTES, 'UTF-8'); ?></div>
    ...
    <?php if ($comment_next_page_data != null && count($comment_next_page_data) > 0) : ?>
        <a href="<?php echo $url, '?page=' . ($page + 1) . '&limit=' . $limit . '&sort=' . $sort; ?>" class="btn1 btn-primary form-control2" data-url="<?php echo $url; ?>" id="load_more_comment" data-page="<?php echo $page + 1; ?>" data-limit="<?php echo $limit; ?>" data-sort="<?php echo $sort; ?>" title="Load more">Load more <?php echo $count_more; ?> comments</a>
    <?php endif; ?>
<?php endif; ?>