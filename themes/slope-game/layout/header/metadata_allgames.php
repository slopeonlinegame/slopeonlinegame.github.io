<?php
$meta_title = 'Play All Games On ' . \helper\options::options_by_key_type('site_name');
if (empty($meta_description)) {
    $list_games = \helper\game::get_paging(1, 5, $keywords, $type, $display, $is_hot, $is_new, 'publish_date', 'DESC');
    $count = count($list_games);
    $meta_description = 'Come and enjoy the best All Games:';
...
$url = rtrim(\helper\options::options_by_key_type('base_url'), "/").load_url()->uri();
