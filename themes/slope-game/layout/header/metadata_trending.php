...
$meta_title = 'Play Trending Games On ' . $site_name;
if (empty($meta_description)) {
    $list_games = \helper\game::get_top('DAY', 1, 5, $type);
    $count = count($list_games);
    $meta_description = 'Come and enjoy the best Trending:';
